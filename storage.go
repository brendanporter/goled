...
func getImages() []string {
	...
	for name, p := range images {
		...
		img2html := "<div class='imgContainer'><h2>" + name + "</h2><span class='glyphicon glyphicon-remove-sign close-btn'></span><br/><img src=\"data:image/png;base64," + imgBase64Str + "\" onclick=\"loadImageToCanvas('" + name + "')\" /></div>"
