...
/*
#cgo CFLAGS: -std=c99 -I/home/pi/rpi-rgb-led-matrix/include -DSHOW_REFRESH_RATE
#cgo LDFLAGS: -lrgbmatrix -L/home/pi/rpi-rgb-led-matrix/lib -lstdc++ -lm
...
func NewRGBLedMatrix(config *HardwareConfig) (c Matrix, err error) {
	...
	r := &C.struct_RGBLedRuntimeOptions{}
	r.gpio_slowdown = C.int(config.GPIOSlowdown)
	m := C.led_matrix_create_from_options_and_rt_options(config.toC(), r)
